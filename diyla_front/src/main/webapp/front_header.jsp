                ...
                <div class="user_option">
                    <c:choose>
                        ...
                        <c:otherwise>
                                ...
                                <a href="http://localhost:8081/diyla_front/shop/getlist/${memId}" id="shoppingcart" class="position-relative" style="margin-left: 10px">
                                ...
                                <span class="cartQuantity text-white bg-warning" id="cartQuantity" data-memid="<%=session.getAttribute("memId")%>" >0</span>
                                </a>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@10.15.5/dist/sweetalert2.all.min.js"></script><script>
