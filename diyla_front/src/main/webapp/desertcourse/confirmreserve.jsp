...
<head>
    ...
    Int headcout = Integer.parseInt(request.getParameter("headcount"));
    %>
    <%
...
$(document).ready(function () {
    if(${userSession}){
        ...
        .then (function (data) {
            let courseInfoHtml = '';
            data.forEach(function (courseInfo){
                courseInfoHtml += "<p id='coursename'>" + "課程名稱" + courseInfo.courseName + "</p>";
                courseInfoHtml += "<p id='coursepic'>" + courseInfo.coursePic + "</p>";
                ...
                courseInfoHtml += "<button id='confirmreserve'>確定報名</button>";
                courseInfoHtml += "<button id='cancel'>取消報名</button>";
