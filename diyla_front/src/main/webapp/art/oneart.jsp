    ...
    <div id="one_art">
        <div class="post-container">
            <div class="post-image">
                <img src="data:image/jpeg;base64,${Base64.getEncoder().encodeToString(artVO.artPic)}" alt="文章圖片">
            </div>
                    ...
                    <ul class="ul_msg">
                        <c:forEach var="artMsgVO" items="${list}">
                            ...
                            <li class="li_msg">
                                ...
                                ${artMsgVO.memVO}
                                <button class="report-icon" onclick="report_message()" type="submit">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="gold" class="w-6 h-6" width="20px" height="20px">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                                    </svg></button>                                    <fmt:formatDate value="${artMsgVO.msgTime}" pattern="yyyy-MM-dd HH:mm" /><br>
                                <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"
                                        width="20px" height="20px">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a5.969 5.969 0 01-.474-.065 4.48 4.48 0 00.978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
                                    </svg></div> ${artMsgVO.msgContext}
                            </li>
                                    <input id="msgNo" name="msgNo" type="hidden" value="${artMsgVO.msgNo}" />
                            <hr>
                            </c:if>
                        </c:forEach>
                    </ul>
