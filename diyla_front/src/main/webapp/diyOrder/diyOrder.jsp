...
<!--====================================================監聽有無更改和取消訂單====================================================== -->
 window.onload=function(){
	 ...
	 if(refund_check.value === '1'){
		 swal('退款成功!', '${diyReserveDate} ${diyPeriod} 的訂位已取消訂位成功，需一至三個工作天退款完成！', 'success');
	 }else if(refund_check.value === '2'){
		 swal('取消訂單成功!', '${diyReserveDate} ${diyPeriod} 的訂位已取消訂位，款項因超過時效而無法退款！', 'success');
	 }
	}
 <!--====================================================== Modal 2 ====================================================== -->
