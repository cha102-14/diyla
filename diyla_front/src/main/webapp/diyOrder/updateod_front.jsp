...
<body>
	...
	<header>
		<span>
			<h1 class="header-title">變更訂單聯絡資訊</h1>
...
<!-- 			</p> -->
	...
	<form action="DiyOrderFrontController" method="post" id="form">
		...
		<input type="text" name="contactPerson" id="contactPerson" value="${DiyOrderVO.contactPerson}">	
			
		<br>
			 
		<label for="contactPhone">聯絡電話:</label> 	
		<input type="text" name=contactPhone id="contactPhone" value="${DiyOrderVO.contactPhone}">
