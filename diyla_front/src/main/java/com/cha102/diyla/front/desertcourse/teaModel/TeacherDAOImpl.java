...
public class TeacherDAOImpl implements TeacherDAO {
    ...
    @Override
    public void insert(com.cha102.diyla.sweetclass.teaModel.TeacherVO teacherVO) {
        Connection con = null;
    ...
    @Override
    public void update(com.cha102.diyla.sweetclass.teaModel.TeacherVO teacherVO) {
        Connection con = null;
        PreparedStatement pstmt = null;
    ...
    @Override
    public com.cha102.diyla.sweetclass.teaModel.TeacherVO findByPrimaryKey(Integer teaID) {
        com.cha102.diyla.sweetclass.teaModel.TeacherVO teacherVO = null;
        Connection con = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        ...
        try {
            ...
            while (rs.next()) {
                teacherVO = new com.cha102.diyla.sweetclass.teaModel.TeacherVO();
    ...
    @Override
    public List<com.cha102.diyla.sweetclass.teaModel.TeacherVO> getAll() {
        List<com.cha102.diyla.sweetclass.teaModel.TeacherVO> list = new ArrayList<com.cha102.diyla.sweetclass.teaModel.TeacherVO>();
        com.cha102.diyla.sweetclass.teaModel.TeacherVO teacherVO = null;
