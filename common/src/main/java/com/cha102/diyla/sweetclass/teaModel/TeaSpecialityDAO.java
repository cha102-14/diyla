...
public class TeaSpecialityDAO implements TeaSpecialityDAO_interface{
    ...
    private static final String DELETE =
            "DELETE FROM tea_speciality where tea_id = ?, spe_id = ?";
    ...
    @Override
    public TeaSpecialityVO findByPrimaryKey(Integer teaID, Integer speID) {
