package com.cha102.diyla.sweetclass.email;
...
public class MailService {
    ...
    public void sendMail(String to, String memName, String action) {
        ...
        try {
            ...
            //     ●5-3) 最後按【產生】密碼
            final String myGmail = "xx584620@gmail.com";
            final String myGmail_password = "jbpqpskgixwqcbar";
            ...
            String subject = null;
            String messageText = "";
            if("createReserve".equals(action)){
                subject = "您的甜點訂單已成立";
