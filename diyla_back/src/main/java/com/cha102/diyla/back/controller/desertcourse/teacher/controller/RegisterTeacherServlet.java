...
public class RegisterTeacherServlet extends HttpServlet {
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        StringBuilder picError = new StringBuilder();
        ...
        Integer gender = Integer.valueOf(req.getParameter("teaGender"));
        ...
        //前端回傳圖片處理
        InputStream in = req.getPart("teaPic").getInputStream();
        byte[] teaPic = null;
        if(in.available() != 0) {
        ...
        if(registerCode == 1){
           jsonObject.put("isSuccessful", 1);
        } else {
            jsonObject.put("isSuccessful", 0);
        }
