                                ...
                                $('#reserveTable').DataTable({
                                    ...
                                    columnDefs: [{
                                        ...
                                        render: function (data, type, row, meta) {
                                            if (row.status === "預約單成立") {
                                                return '<div class="button-group"><button class="delete-btn btn btn-success" data-reserveId="' + row.reserveId + '">完成訂單</button>'+
                                                '<button class="delete-btn btn btn-danger" data-reserveId="' + row.reserveId + '">取消訂單</button></div>'
                                                    ;
                                            }
                                            else {
                                                return '<div class="button-group"><button disabled class="delete-btn btn btn-success" data-reserveId="' + row.reserveId + '">完成訂單</button>'+
