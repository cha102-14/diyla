                                        ...
                                        <%@ page import="java.util.Base64" %>
                                            ...
                                            <head>
                                                ...
                                                <link rel="stylesheet" type="text/css"
                                                    href="${ctxPath}/desertcourse/css/desertcourse_style.css" />
                                                    ...
                                                    <div id="naviContentBlock">
                                                        ...
                                                        <div id="contentBlock">
                                                            <div id="formBlock">
                                                                ...
                                                                <form action="${ctxPath}/modifyCourse" method="post"
                                                                    enctype="multipart/form-data">
                                                                    <input type="hidden" id="modifyCourseId"
                                                                        name="modifyCourseId"
                                                                        value="${courseVO.classId}">
                                                                    <div class="row">
                                                                        <c:choose>
...
=======
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
>>>>>>> a772c4fcdb3303afd7a896b5a66de77296a39154
<%@ page import="com.cha102.diyla.sweetclass.teaModel.TeacherVO" %>
<%@ page import="com.cha102.diyla.sweetclass.teaModel.TeacherService" %>
<%@ page import="com.cha102.diyla.sweetclass.classModel.ClassVO" %>
<%@ page import="com.cha102.diyla.sweetclass.classModel.ClassService" %>
                        ...
                        <form action="${ctxPath}/modifyCourse" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div id="registerEndDateBlock"
                                    ...
                                    <input type="datetime-local" id="regEndDate"
                                                                                        ...
                                                                                        <div class="ingredient-row row">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <label
                                                                                                    class>食材控制</label><br>
                                                                                                <button type="button"
                                                                                                    class="removeButton form-control btn btn-secondary"
                                                                                                    id="ingDecreaseButton${loop1.index + 1}"
                                                                                                    style="width: 5vw;">移除食材</button>
                                                                                            </div>
                                                                                        </div>
...
>>>>>>> 804a8dec9b150a3453203e6a2784e3f322398ad0
                                                                    ...
                                                                    <div id="buttonBlock" class="col-md-6 form-group"
                                                                        style:>
                                                                        <button type="submit"
                                                                            class="btn btn-secondary form-control"
                                                                            id="submitButton"
                                                                            style="width: 5vw;">修改甜點課程</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
