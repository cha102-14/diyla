                ...
                <c:otherwise>
                    <c:forEach var="typeFun" items="${typeFun}">
                        <c:if test="${typeFun eq 'BACKADMIN'}">
                            <li class="func">
                                <a href="${ctxPath}/emp/empShowAll.jsp" class="func_link">
                        ...
                        <c:if test="${typeFun eq 'MEMADMIN'}">
                            <li class="func">
                                <a href="${ctxPath}/mem/memShowAll.jsp" class="func_link">
                        ...
                        <c:if test="${typeFun eq 'CUSTORSERVICE'}">
                            ...
                            <li class="func">
                                <a href="${ctxPath}/pbm/pbmall.jsp" class="func_link">
                                    <svg fill="#b45f06" id="Capa_7" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <li class="func">
                                <a href="${ctxPath}/latestnews/latall.jsp" class="func_link">
                                    <svg viewBox="0 0 1024 1024" fill="#b45f06" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                         id="Capa_5">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                           stroke-linejoin="round"></g>
