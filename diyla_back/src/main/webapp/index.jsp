...
<div class="wrapper">
    <aside id="aside">
        <h1 class="logo"><a href="http://localhost:8081/diyla_back/"><img src="${ctxPath}/img/DIYLA_LOGO.png"
                                                                          alt="DIYLA!" class="logo-image"></a></h1>
        <ul>
            <c:choose>
                ...
                <c:otherwise>
                    <c:forEach var="typeFun" items="${typeFun}">
                        <c:if test="${typeFun eq 'BACKADMIN'}">
                            <li class="func">
                                <a href="#" class="func_link">
                                    <svg fill="#b45f06" version="1.1" id="Capa_1" width="20" height="20"
                        ...
                        <c:if test="${typeFun eq 'MEMADMIN'}">
                            <li class="func">
                                <a href="http://127.0.0.1:5500/sideBar/test.html" class="func_link">
                                    <svg fill="#b45f06" version="1.1" id="Capa_2" width="20" height="20"
                                         xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        <c:if test="${typeFun eq 'STORADMIN'}">
                            <li class="func">
                                <a href="http://127.0.0.1:5500/sideBar/test.html" class="func_link">
                                    <svg fill="#b45f06" version="1.1" id="Capa_6" width="20" height="20"
                                         xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                         viewBox="0 0 973.199 973.199" xml:space="preserve" stroke="#b45f06"><g
                                            id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                           stroke-linejoin="round"></g>
                                        <g id="SVGRepo_iconCarrier">
                                            <g>
                                                <path d="M924,828.75V315.649c-3.6,0.3-7.199,0.5-10.801,0.5H60c-3.6,0-7.3-0.2-10.8-0.5V828.75c0,33.1,26.9,60,60,60H864 C897.1,888.75,924,861.949,924,828.75z M687,513.35c0,16.6-13.4,30-30,30H316.2c-16.6,0-30-13.4-30-30v-79.6 c0-16.601,13.4-30,30-30H656.9c16.6,0,30,13.399,30,30v79.6H687z"></path>
                                                <path d="M973.199,196.149v-51.7c0-33.1-26.898-60-60-60H60c-33.1,0-60,26.9-60,60v51.7c0,29.4,21.2,53.9,49.2,59 c3.5,0.6,7.1,1,10.8,1h853.1c3.701,0,7.301-0.4,10.801-1C952,250.049,973.199,225.549,973.199,196.149z"></path>
                                            </g>
                                        </g></svg>
                                    倉儲管理
                                </a>
                        ...
                        <c:if test="${typeFun eq 'CUSTORSERVICE'}">
                            <li class="func">
                                <a href="http://127.0.0.1:5500/sideBar/test.html" class="func_link">
                                    <svg fill="#b45f06" version="1.1" id="Capa_7" xmlns="http://www.w3.org/2000/svg"
