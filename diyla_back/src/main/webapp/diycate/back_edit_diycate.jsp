                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="cateForm">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input id="diyNo" name="diyNo" type="text" class="form-control" hidden>
                                        <div class="mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="itemDetails" name="itemDetails"
                                                      rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#submitBtn").click(function (event) {
            ...
            // 檢查DIY品項名稱和DIY金額是否為空值，以及金額是否為數字
            if (diyName.trim() === '') {
                Swal.fire({
                    icon: 'error',
                    title: '錯誤',
