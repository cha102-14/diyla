...
(
    ...
    EMP_NAME     VARCHAR(50)        NOT NULL COMMENT '管理員名稱',
...
(
    EMP_ID  INT,
    CONSTRAINT FK_AUTHORITY_EMPLOYEE
...
(
    ...
    RECIPIENT_ADDRESS VARCHAR(100)                        NOT NULL COMMENT '收件地址',
    PHONE            VARCHAR(10)                         NOT NULL COMMENT '電話號碼',
...
(
    ...
    `CLASS_STAUS`  TINYINT      NOT NULL, -- (0:下架，1:上架，2:已結束，3:取消)
...
(
    ...
    DIY_CATE_NAME     TINYINT       NOT NULL DEFAULT 0 COMMENT 'DIY類別，(0:其他，1:蛋糕，2:餅乾，3:麵包)',
